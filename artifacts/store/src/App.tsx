...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/shop/male">
        <Layout><ShopPage section="male" /></Layout>
      </Route>
      <Route path="/shop/female">
        <Layout><ShopPage section="female" /></Layout>
      </Route>
      <Route path="/shop/children">
        <Layout><ShopPage section="children" /></Layout>
      </Route>
      ...
      {/* Customer Auth */}
      <Route path="/login">
        <Layout><CustomerAuthPage mode="login" /></Layout>
      </Route>
      <Route path="/signup">
        <Layout><CustomerAuthPage mode="signup" /></Layout>
      </Route>
      <Route path="/account">
