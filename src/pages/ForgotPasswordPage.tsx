        ...
        {sent ? (
          <div className="bg-card border border-border rounded-2xl p-10 text-center shadow-sm">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              We've sent a password reset link to <strong className="text-foreground">{email}</strong>. It will expire in 1 hour.
            </p>
            <Link href="/login"><Button variant="outline" className="w-full rounded-xl py-5">Back to Sign In</Button></Link>
          </div>
        ) : (
          <div className="bg-card border border-border rounded-2xl p-8 shadow-sm">
            <div className="mb-7">
              <h2 className="text-2xl font-bold text-foreground">Forgot password?</h2>
              <p className="text-muted-foreground text-sm mt-1.5 leading-relaxed">Enter your email and we'll send you a reset link.</p>
            </div>
